...
export class DataTableDialog extends React.Component<IPropDataTableDialog, IStateDataTableDialog> {
    ...
    render() {
        ...
        return (
            <Dialog style={{width: '80%', minWidth: '1000px'}} icon="home" onClose={this.handleClose} title={'' /*selectedObjects ? selectedObjects.data.buildingName : 'Building Not Found'*/} {...this.state}>
